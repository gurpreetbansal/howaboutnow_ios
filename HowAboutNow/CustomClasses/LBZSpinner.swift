...
@IBDesignable class LBZSpinner : UIView, UITableViewDelegate, UITableViewDataSource {
    ...
    @IBInspectable var textColor: UIColor = UIColor.lightGray { didSet{ updateUI() } }
    @IBInspectable var lineColor: UIColor = UIColor.lightGray { didSet{ updateUI() } }
    ...
    //@IBInspectable var dDLAddViewLine:UIView
    ...
    func decoratedDropDownList(_ backgroundColor:UIColor!,textColor:UIColor!,withStroke:Bool!,strokeSize:CGFloat!,strokeColor:UIColor!,addViewline:UIView!) {
        ...
        if(strokeColor != nil) { dDLStrokeColor=strokeColor }
        //if(addViewline != nil) { dDLAddViewLine=addViewline }
    }
    ...
    @objc func openSpinner(_ sender:UITapGestureRecognizer){
        ...
        tableviewChoose.separatorStyle = UITableViewCell.SeparatorStyle.singleLine
...
//                    self.tableviewChooseShadow.removeFromSuperview()
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        lineView = UIView(frame: CGRect(x: 0, y: cell.frame.size.height, width: cell.frame.size.width, height: 1))
